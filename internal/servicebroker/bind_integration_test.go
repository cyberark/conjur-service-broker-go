...
func Test_server_ServiceBindingBinding(t *testing.T) {
	...
	mockAPI.On("ResourceExists", "dev:host:cf/e027f3f6-80fe-4d22-9374-da23a035ba0b/8c56f85c-c16e-4158-be79-5dac74f970de/bb841d2b-8287-47a9-ac8f-eef4c16106f2").Return(false, nil).Once()
...
func Test_server_ServiceBindingBindingSpaceIdentity(t *testing.T) {
	client, mockAPI := conjur.NewMockClient()
	mockAPI.On("ResourceExists", "dev:host:cf/e027f3f6-80fe-4d22-9374-da23a035ba0b/8c56f85c-c16e-4158-be79-5dac74f970de").Return(true, nil).Once()
...
func Test_server_ServiceBindingUnbinding(t *testing.T) {
	...
	mockAPI.On("ResourceExists", "dev:host:cf/{orgID}/{spaceID}/bb841d2b-8287-47a9-ac8f-eef4c16106f2").Return(true, nil).Once()
