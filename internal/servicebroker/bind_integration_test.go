...
func Test_server_ServiceBindingBinding(t *testing.T) {
	...
	mockAPI.On("ResourceExists", "dev:group:cf/e027f3f6-80fe-4d22-9374-da23a035ba0b/8c56f85c-c16e-4158-be79-5dac74f970de").Return(false, nil).Once()
	mockAPI.On("ResourceExists", "dev:layer:cf/e027f3f6-80fe-4d22-9374-da23a035ba0b/8c56f85c-c16e-4158-be79-5dac74f970de").Return(false, nil).Once()
...
func Test_server_ServiceBindingUnbinding(t *testing.T) {
	...
	mockAPI.On("LoadPolicy", conjurapi.PolicyModePatch, "cf/{orgID}/{spaceID}", mock.Anything).Return(policyResp, nil).Once()
	s := &server{client: client}
