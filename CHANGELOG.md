...
### Security
-   Updated Nokogiri to 1.12.5-x86\_64-darwin to resolve
...
### Fixed
-   When the value for CONJUR\_VERSION is null or empty, we default to `5`. If an invalid
...
[Unreleased]: https://github.com/cyberark/conjur-service-broker-go/compare/v1.3.4...HEAD
[1.3.4]: https://github.com/cyberark/conjur-service-broker/compare/v1.3.3...v1.3.4
...
[0.3.2]: https://github.com/cyberark/conjur-service-broker/compare/v0.3.1...v0.3.2
...
[0.1.0]: https://github.com/cyberark/conjur-service-broker/releases/tag/v0.1.0
