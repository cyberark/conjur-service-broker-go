...
require (
	...
	github.com/cyberark/conjur-api-go v0.13.0 // Run "go get github.com/cyberark/conjur-api-go@main" to update
...
replace github.com/cyberark/conjur-api-go => github.com/cyberark/conjur-api-go v0.13.0
